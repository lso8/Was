...
MinimizeButton.Position = UDim2.new(0.9, -35, 0.05, 0)
...
-- Круг для свернутого состояния
local MinimizedCircle = Instance.new("Frame")
MinimizedCircle.Name = "MinimizedCircle"
MinimizedCircle.Parent = ExecutorGui
MinimizedCircle.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
MinimizedCircle.Position = UDim2.new(0.05, 10, 0.95, -40)
...
MinimizedCorner.Parent = MinimizedCircle
...
MinimizedGradient.Parent = MinimizedCircle
local MinimizedLabel = Instance.new("TextLabel")
MinimizedLabel.Parent = MinimizedCircle
MinimizedLabel.BackgroundTransparency = 1
MinimizedLabel.Size = UDim2.new(1, 0, 1, 0)
MinimizedLabel.Font = Enum.Font.GothamBold
MinimizedLabel.Text = "xAI"
MinimizedLabel.TextColor3 = Color3.fromRGB(200, 150, 255)
MinimizedLabel.TextSize = 14
MinimizedLabel.TextStrokeTransparency = 0.6
...
-- Поле ввода ника для телепорта
local TeleportInput = Instance.new("TextBox")
TeleportInput.Name = "TeleportInput"
TeleportInput.Parent = ChatGui
TeleportInput.BackgroundColor3 = Color3.fromRGB(40, 50, 70)
TeleportInput.Position = UDim2.new(0.65, 0, 0.05, 0)
TeleportInput.Size = UDim2.new(0, 90, 0, 25)
TeleportInput.Font = Enum.Font.Gotham
TeleportInput.PlaceholderText = "Enter nickname..."
TeleportInput.Text = ""
TeleportInput.TextColor3 = Color3.fromRGB(200, 200, 200)
...
TeleportButton.Parent = ChatGui
TeleportButton.Position = UDim2.new(0.65, 0, 0.25, 0)
TeleportButton.Size = UDim2.new(0, 90, 0, 25)
...
MinimizeButton.MouseEnter:Connect(function() tweenButton(MinimizeButton, UDim2.new(0, 27, 0, 27)) end)
MinimizeButton.MouseLeave:Connect(function() resetButton(MinimizeButton, UDim2.new(0, 25, 0, 25)) end)
MinimizeButton.MouseButton1Down:Connect(function() pressButton(MinimizeButton) end)
...
TeleportButton.MouseEnter:Connect(function() tweenButton(TeleportButton, UDim2.new(0, 95, 0, 27)) end)
TeleportButton.MouseLeave:Connect(function() resetButton(TeleportButton, UDim2.new(0, 90, 0, 25)) end)
TeleportButton.MouseButton1Down:Connect(function() pressButton(TeleportButton) end)
...
TeleportButton.MouseButton1Click:Connect(function()
    ...
    if targetName ~= "" then
        ...
        if targetPlayer and targetPlayer.Character and LocalPlayer.Character then
            ...
            StatusCircle.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Красный
        end
    end
end)
